...
<html ng-app="BloodRepositoryApp">
  ...
  <head>
    <meta charset="utf-8" />
    <title>Search Blood Samples</title>
  ...
  <body ng-controller="SearchBloodSamples">
        ...
        <div class="row">
            <div class="col-sm-12" id="builder">
                <ul class="list-group row" ng-repeat="blood_sample in blood_samples" ng-click="redirect_to_blood_sample_location(blood_sample.id)">
